...
class FastFoodRestaurant extends RestaurantA {
...
class FineDiningRestaurant extends RestaurantA {
...
public class Restaurant {
    public static void main(String[] args) {
        RestaurantA genericRestaurant = new RestaurantA("Normal ");
