...
public class Library {
    public static void main(String[] args) {
        Books book=new Books(1, "Java Programming", "Author Z", "2026", 499.99f, "Available");
        book.DisplayBookDetails();

        Librarian librarian=new Librarian( 281371, "Jeny");
        librarian.SearchBook("Java Programming");
        
        Publisher publisher=new Publisher(30231, "X Publishers", "456 Avenue", 987654321);
        publisher.OrderStatus();

        User user=new User(34201, "Alex", "123 Street", 123456789);
        user.BookPurchase();
        user.PayFine(7); 
}
}